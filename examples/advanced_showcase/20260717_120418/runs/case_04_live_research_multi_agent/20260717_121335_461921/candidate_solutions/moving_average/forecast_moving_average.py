...
CAPABILITY_SPEC = {'name': 'moving_average', 'task_type': 'inventory_forecasting', 'description': 'Forecast stable demand with the mean of the most recent observations.', 'template_name': 'moving_average', 'input_contract': 'Non-negative daily demand history and a positive forecast horizon.', 'output_contract': 'Non-negative daily forecast and horizon-total target inventory.', 'suitable_for': ('short_history', 'stable'), 'metrics': ('bias', 'inventory_cost', 'rmse', 'smape', 'wape'), 'dependencies': ('pandas',), 'parameters': {'window': 14}, 'source_type': 'document', 'source_ref': 'F:\\AgentProjects\\TimeSeriesScientist\\examples\\capabilities\\moving_average.md', 'source_hash': '4191b6ea63dffed1ef8738a34e30ad7dc2f17de83b8edd528df5a7abfa735e9d', 'version': '1.1.0', 'extracted_by': 'llm', 'source_title': 'The accuracy of intermittent demand estimates', 'source_url': 'https://www.sciencedirect.com/science/article/pii/S0169207004000792', 'source_license': 'citation_only', 'accessed_at': '2026-07-16', 'confidence': 0.9, 'review_status': 'source_reviewed', 'evidence_refs': ('SMA benchmark description', 'inventory_agent/forecasting/models.py:22'), 'extraction_warnings': (), 'implementation_kind': 'algorithm', 'entrypoints': (), 'internal_dependencies': (), 'complexity': {}}
